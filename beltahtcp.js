...
zk.ev.on('call', async (callData) => {
  ...
  await handleAntiDelete(zk, conf, m);
        ...
        zk.ev.on("messages.upsert", async (m) => {
            ...
            const keith = '254114141192';
            const Keithkeizzah = '254737681758';
            const Ghost = "254114141192";
            const Sams = '254737681758';
        ...
        if (cd) {
          try {
            ...
            if (!superUser && origineMessage === auteurMessage&& conf.PM_PERMIT === "yes" ) {
                repondre("Sorry!! You have no access of Beltah Md bot in pm. ") ; return }
            ///////////////////////////////
